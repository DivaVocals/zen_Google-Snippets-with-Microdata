...
//$messageStack->add('Google Snippets with Microdata v1.4 install started','success');
    ...
    $sql = "DELETE FROM ".DB_PREFIX."configuration WHERE configuration_group_id ='".$gsmd_configuration_id."'";
        $db->Execute($sql);

//-- ADD VALUES TO GOOGLE SNIPPETS WITH MICRODATA CONFIGURATION GROUP (Admin > Configuration > Google Snippets with Microdata) --
    $sql = "INSERT INTO ".DB_PREFIX."configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'Product Condition', 'MICRODATA_PRODUCT_CONDITION', '<span itemprop=\"condition\" content=\"new\">New</span>', 'Using Rich Snippets to identify product condition. Any text may be specified. If the <code>condition</code> attribute is used, the value of the <code>content</code> attribute must be one of the following recognized values:<ul><li><code>new</code></li><li><code>used</code></li><li><code>refurbished</code></li></ul><p>For example:</p><pre>&lt;span itemprop=\"condition\" content=\"new\"&gt;Brand new!&lt;/span&gt;</pre><br /><br />Default value is: <span itemprop=\"condition\" content=\"new\">New</span>.', '".$gsmd_configuration_id."', 5, now(), now(), NULL, NULL)";
    $db->Execute($sql);
    $sql = "INSERT INTO ".DB_PREFIX."configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'Product Price Currency', 'MICRODATA_CURRENCY', 'USD', 'Using Rich Snippets to identify the product currency.<br /><br />The currency used to describe the product price, in <a href=\"http://www.iso.org/iso/support/faqs/faqs_widely_used_standards/widely_used_standards_other/currency_codes.htm\" target=\"_blank\">three-letter ISO</a> format.', '".$gsmd_configuration_id."', 10, now(), now(), NULL, NULL)";
    $db->Execute($sql);
    $sql = "INSERT INTO ".DB_PREFIX."configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'Product Identifier', 'MICRODATA_IDENTIFIER', 'mpn:', '<p>The product identifier. Google recommends including <code>brand</code> and at least one <code>identifier</code> for each product.</p><p>Recognized types include:</p><ul><li><code>asin</code></li><li><code>isbn</code></li><li><code>mpn</code></li><li><code>sku</code></li><li><code>upc</code></li></ul><p>You MUST include a colon (:) at the end of the identifier. e.g. <strong>mpn:</strong></p>', '".$gsmd_configuration_id."', 15, now(), now(), NULL, NULL)";
    $db->Execute($sql);
    $sql = "INSERT INTO ".DB_PREFIX."configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'Payments Accepted', 'MICRODATA_PAYMENTS_ACCEPTED', '<span itemprop=\"http://purl.org/goodrelations/v1#acceptedPaymentMethods\" href=\"http://purl.org/goodrelations/v1#PayPal\" />PayPal</span>, <span itemprop=\"http://purl.org/goodrelations/v1#acceptedPaymentMethods\" href=\"http://purl.org/goodrelations/v1#VISA\" />Visa</span>, <span itemprop=\"http://purl.org/goodrelations/v1#acceptedPaymentMethods\" href=\"http://purl.org/goodrelations/v1#MasterCard\" />MasterCard</span>, <span itemprop=\"http://purl.org/goodrelations/v1#acceptedPaymentMethods\" href=\"http://purl.org/goodrelations/v1#Discover\" />Discover</span>', 'Using Rich Snippets to identify the payment methods you accept. The syntax provided is for Visa, MasterCard, Discover and PayPal.<br /><br />Other methods can be found here (<a href=\"http://www.heppnetz.de/ontologies/goodrelations/v1#PaymentMethod\" target=\"_blank\">http://www.heppnetz.de/ontologies/goodrelations/v1#PaymentMethod</a>)', '".$gsmd_configuration_id."', 20, now(), now(), NULL, NULL)";
    $db->Execute($sql);
    $sql = "INSERT INTO ".DB_PREFIX."configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'Delivery Lead Time', 'MICRODATA_DELIVERY_LEADTIME', '21', 'Using Rich Snippets to identify the general delivery lead time (in days) for your products', '".$gsmd_configuration_id."', 25, now(), now(), NULL, NULL)";
    $db->Execute($sql);
    $sql = "INSERT INTO ".DB_PREFIX."configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'Shipping Region(s)', 'MICRODATA_SHIPPING_REGIONS', '<span itemprop=\"eligibleRegion\" content=\"US\">United States</span> &amp; <span itemprop=\"eligibleRegion\" content=\"CA\">Canada</span>', 'Using Rich Snippets to identify the shipping region(s) for your products.<br /><br />Note that the proper 2 letter country code must be used for the content=\"\", but the text following can be express however you like.', '".$gsmd_configuration_id."', 30, now(), now(), NULL, NULL)";
    $db->Execute($sql);
    $sql = "INSERT INTO ".DB_PREFIX."configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'Enable Availability?', 'MICRODATA_PRODUCT_AVAILABILITY_YN', 'False', 'Enable availability',  '".$gsmd_configuration_id."', 35, now(), now(), NULL, 'zen_cfg_select_option(array(''True'', ''False''),')";
    $db->Execute($sql);
    $sql = "INSERT INTO ".DB_PREFIX."configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'Enable Product Conditions?', 'MICRODATA_PRODUCT_CONDITION_YN', 'False', 'Enable conditions',  '".$gsmd_configuration_id."', 40, now(), now(), NULL, 'zen_cfg_select_option(array(''True'', ''False''),')";
    $db->Execute($sql);
    ...
    $db->Execute($sql);
    $sql = "INSERT INTO ".DB_PREFIX."configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'Enable Payments Accepted?', 'MICRODATA_PRODUCT_PAYMENTS_YN', 'False', 'Enable payments',  '".$gsmd_configuration_id."', 50, now(), now(), NULL, 'zen_cfg_select_option(array(''True'', ''False''),')";
    $db->Execute($sql);
    $sql = "INSERT INTO ".DB_PREFIX."configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'Enable Delivery Lead Time?', 'MICRODATA_PRODUCT_DELIVERY_YN', 'False', 'Enable delivery lead time',  '".$gsmd_configuration_id."', 55, now(), now(), NULL, 'zen_cfg_select_option(array(''True'', ''False''),')";
    $db->Execute($sql);
    $sql = "INSERT INTO ".DB_PREFIX."configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'Enable Shipping Region(s)?', 'MICRODATA_PRODUCT_SHIPTO_YN', 'False', 'Enable shipping region(s)',  '".$gsmd_configuration_id."', 60, now(), now(), NULL, 'zen_cfg_select_option(array(''True'', ''False''),')";
    $db->Execute($sql);
//-- GOOGLE SNIPPETS WITH MICRODATA VERSION
    $sql = "INSERT INTO ".DB_PREFIX."configuration (configuration_id, configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES (NULL, 'Google Snippets with Microdata Version', 'GSMD_VERSION', '1.4', 'Google Snippets with Microdata Version', '".$gsmd_configuration_id."', 999, NULL, now(), NULL, NULL)";
    $db->Execute($sql);
